...
def number_odd_or_even(n):
    ...
    if n % 2 == 0:
        m = str(n)
        return render_template('templates/6.number_odd_or_even.html', number=m, odd_even='even')
    else:
        m = str(n)
        return render_template('templates/6-number_odd_or_even.html', number=m, odd_even='odd')
